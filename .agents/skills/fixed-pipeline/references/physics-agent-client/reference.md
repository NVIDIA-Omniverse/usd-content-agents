...
description: "Fixed pipeline reference: Make requests to the Physics Agent REST API for component classification, physics authoring, tuning, and refinement. Use when the user explicitly requests the fixed pipeline service/client, uploads, REST monitoring, downloads, or a client script; use the agentic Content Workflow for unqualified physics tasks."
version: "0.1.1"
...
# Fixed Pipeline Reference: Physics Agent Client
