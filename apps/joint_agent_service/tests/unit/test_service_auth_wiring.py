...
"""Bearer-token enforcement wiring for the Joint Agent Service (issue #956).

Enforcement is opt-in: with JOINT_AGENT_TOKEN unset the service behaves exactly as it
...
TOKEN_ENV = "JOINT_AGENT_TOKEN"
PROBE = "/sessions"
OPEN_PATHS = ("/health", "/api", "/", "/openapi.json")
MIN_PROTECTED_PATHS = 16
