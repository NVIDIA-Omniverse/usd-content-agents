...
def main():
    ...
    if a.cgroup:
        expected={'cpu.max':'200000 100000','memory.max':str(8*1024**3),'memory.swap.max':'0','pids.max':'512'}
        if a.cgroup.name!='evaluator-v2':raise ValueError('Only the delegated evaluator-v2 leaf is permitted')
